...
<a href="https://github.com/datweb3guy/starksend" target="_blank" rel="noopener noreferrer" className="text-[13px] text-[var(--text3)] hover:text-white transition-colors">GitHub</a>
<a href="https://x.com/Datweb3guy" target="_blank" rel="noopener noreferrer" className="text-[13px] text-[var(--text3)] hover:text-white transition-colors">Twitter</a>
          ...
          <div className="text-xs text-[var(--text3)]">
            Built on Starknet by Datweb3guy
          </div>
        </div>
      </footer>
    </>
